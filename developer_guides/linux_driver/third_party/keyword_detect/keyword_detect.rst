...
To learn how to integrate a 3rd-party detection algorithm into the SOF firmware, refer to the upstream `Module Adapter Specification <https://github.com/thesofproject/sof/tree/master/src/audio/module_adapter/README.md>`_ and :ref:`llext_modules`.
